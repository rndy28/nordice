...
import type { TSolidOrGhost } from "../../types";

interface Props extends Omit<React.ComponentPropsWithoutRef<"div">, "children"> {
  variant?: TSolidOrGhost;
  rounded?: boolean;
  iconClassName?: string;
}

const Close = ({ className, iconClassName, rounded, variant = "solid", ...props }: Props) => {
  const mergedClasses = clsx(
    ...
    variant === "solid" && "bg-polarNight2 text-snowStorm0-100 hover:border-polarNight2-500",
